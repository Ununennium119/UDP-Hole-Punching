        ...
        while True:
            try:
                ...
                if self.ids_map.get(dest_id) == source_id:
                    ...
                    self.socket.sendto(self.id_address_map[dest_id][0].encode(), self.id_address_map[source_id][0])
                    self.socket.sendto(self.id_address_map[source_id][0].encode(), self.id_address_map[dest_id][0])
